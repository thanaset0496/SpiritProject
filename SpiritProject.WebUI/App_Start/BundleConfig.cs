...
namespace SpiritProject.WebUI
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // Flags style
            bundles.Add(new StyleBundle("~/bundles/flags/css").Include(
            "~/Vendor/flags-master/css/flag-icon.css", new CssRewriteUrlTransform()));
            ...
            //          "~/Icons/pe-icon-7-stroke/css/helper.css"));
